...
public class CertActivity extends AppCompatActivity {
    ...
    private void generatePDF() {
        ...
        // Measure and layout the certContainer to ensure it is drawn correctly
        certContainer.measure(
                View.MeasureSpec.makeMeasureSpec(certContainer.getWidth(), View.MeasureSpec.EXACTLY),
                View.MeasureSpec.makeMeasureSpec(0, View.MeasureSpec.UNSPECIFIED)
        );
        certContainer.layout(0, 0, certContainer.getMeasuredWidth(), certContainer.getMeasuredHeight());

        // Create a bitmap of the certContainer
        ...
        File file = new File(downloadsDir, "certificate_" + System.currentTimeMillis() + ".pdf");

        try (FileOutputStream fos = new FileOutputStream(file)) {
            document.writeTo(fos);
            Toast.makeText(this, "Certificate saved to Downloads: " + file.getAbsolutePath(), Toast.LENGTH_LONG).show();
        } catch (IOException e) {
            e.printStackTrace();

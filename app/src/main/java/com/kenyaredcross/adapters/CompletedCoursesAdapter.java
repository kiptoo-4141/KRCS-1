...
public class CompletedCoursesAdapter extends RecyclerView.Adapter<CompletedCoursesAdapter.ViewHolder> {
    ...
    private final List<CompletedCoursesModel> requestList;

    public CompletedCoursesAdapter(Context context, List<CompletedCoursesModel> requestList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        CompletedCoursesModel request = requestList.get(position);
    ...
    private void updateAllCoursesStatus(DatabaseReference userEnrollmentsRef, CompletedCoursesModel request, String newStatus) {
